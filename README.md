...
_# Microsoft Foundry: da Observabilidade ao ROI para AI Agents em qualquer plataforma!_

Palestrante: **Renato Groffe (Microsoft MVP, Docker Captain, Grafana Champion, APIsec U Ambassador MTAC)**

Tecnologias e tópicos abordados: **Microsoft Foundry, Agents, Inteligência Artificial, LLMs, Observabilidade, Logs, Métricas, Traces, Azure Monitor, Application Insights, OpenTelemetry, Grafana, Azure Managed Grafana, Docker, Azure Container Registry, Visual Studio Code, Linux, .NET, C#, Python, Hosted Agents, MCP Servers, GitHub...**

_# Sistemas multiagentes com Claw e Agent Harness no Microsoft Foundry_
...
![Público do evento 2](img/publico-03.jpeg)

![Renato palestrando 1](img/renato-07.jpeg)
